# Main to demonstrate using the thread pool to run a variety of
# target functions with different priorities in their own separate threads.
#
# Note: Output to stdout will be messy in multi-threaded code :)

# Imports.
from tpool.pool import pool
import time  # for sleep

# Number of threads to use in demo.
NUMBER_OF_THREADS = 8
